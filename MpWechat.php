...
use fastwhale\wechat\sdk\mp\Card;
use fastwhale\wechat\sdk\mp\Shop;
use fastwhale\wechat\sdk\mp\ShakeAround;
use fastwhale\wechat\sdk\mp\DataCube;
use fastwhale\wechat\sdk\mp\CustomService;
use fastwhale\wechat\sdk\components\BaseWechat;
use fastwhale\wechat\sdk\components\MessageCrypt;
...
class MpWechat extends BaseWechat
{
     ...
     * @return array|bool
     */
    public function requestJsApiTicket($type = 'jsapi')
    {
