<?php
namespace fastwhale\wechat\sdk;
 ...
 *
 * @package fastwhale\wechat\components
 * @version 1.0.0alpha
 */
class Wechat extends Component
{
	 ...
	 * 获取自定义菜单
	 */
    const WECHAT_CURRENT_MENU = '/cgi-bin/get_current_selfmenu_info?';
    /**
     * js api ticket 获取
     */
     ...
     * 创建个性化菜单
     */
    const PERSONALIZED_MENU_CREATE   = '/cgi-bin/menu/addconditional?';
    /**
     * 删除个性化菜单
     */
    const PERSONALIZED_MENU_DELETE   = '/cgi-bin/menu/delconditional?';
    /**
     * 发送客服消息
     */
	 ...
	 * 素材预览接口
	 */
	const WECHAT_PREVIEW_MESSAGE_SEND_URL = '/cgi-bin/message/mass/preview?';
	/**
	 * 获得模板ID
	 */
	const WECHAT_TEMPLATE_API_ADD_TEMPLATE = '/cgi-bin/template/api_add_template?';
     /**
      * 获取所有的模板消息
     */
    const WECHAT_TEMPLATE_GET_URL = '/cgi-bin/template/get_all_private_template?';
    /**
      * 获取行业信息
    */
    const WECHAT_TEMPLATE_INDUSTRY_URL = '/cgi-bin/template/get_industry?';
    /**
     * 消息上传
     */
     ...
     * 根据标签进行群发 消息发送
     */
    const WECHAT_MASS_SEND_All_URL = '/cgi-bin/message/mass/sendall?';
	/**
	 * 根据OpenID列表群发【订阅号不可用，服务号认证后可用】
	 */
	const WECHAT_MASS_SEND_URL = '/cgi-bin/message/mass/send?';
    /**
     * 删除群发
     */
     ...
     * 媒体文件上传
     */
    const WECHAT_MEDIA_UPLOAD_URL = '/cgi-bin/media/upload?';
    /**
     * 媒体文件获取
     */
    const WECHAT_MEDIA_URL = '/cgi-bin/media/get?';
	/**
	 * 上传图文消息内的图片获取URL
	 */
    const WECHAT_MEDIA_UPLOAD_IMG = '/cgi-bin/media/uploadimg?';
	/**
	 * 新增其他类型永久素材
	 */
	const WECHAT_MATERIAL_ADD_URL = '/cgi-bin/material/add_material?';
	/**
	 * 获取永久素材
	 */
	const WECHAT_MATERIAL_GET_URL = '/cgi-bin/material/get_material?';
    /**
     *  分组创建
     */
	 ...
	 * 创建标签
	 */
    const WECHAT_CREATE_TAG_URL = '/cgi-bin/tags/create?';
	/**
	 * 获取公众号已创建的标签
	 */
    const WECHAT_GET_TAG_URL = '/cgi-bin/tags/get?';
	/**
	 * 编辑标签
	 */
    const WECHAT_UPDATE_TAG_NAME_URL = '/cgi-bin/tags/update?';
	/**
	 * 删除标签
	 */
    const WECHAT_DELETE_TAG_URL = '/cgi-bin/tags/delete?';
	/**
	 * 获取标签下粉丝列表
	 */
    const WECHAT_USER_GET_BY_TAG_URL = '/cgi-bin/user/tag/get?';
	/**
	 * 批量为用户打标签
	 */
    const WECHAT_USER_BATCH_TAG_URL = '/cgi-bin/tags/members/batchtagging?';
	/**
	 * 批量为用户取消标签
	 */
    const WECHAT_USER_UNBATCH_TAG_URL = '/cgi-bin/tags/members/batchuntagging?';
	/**
	 * 获取用户身上的标签列表
	 */
    const WECHAT_GET_USER_TAGS_URL = '/cgi-bin/tags/getidlist?';
    /**
     * 修改关注者备注
     */
     ...
     * 批量获取用户基本信息
     */
    const WECHAT_MEMBER_INFO_BATCHGET_URL = '/cgi-bin/user/info/batchget?';
    /**
     * 关注者列表
     */
    ...
    /**
     * 获取平台网页授权后获取用户access_token地址
     */
    const WECHAT_OAUTH2_COMPONENT_ACCESS_TOKEN_URL = '/sns/oauth2/component/access_token?';
    /**
     * 网页授权后获取的access_token失效刷新地址
     */
    const WECHAT_OAUTH2_ACCESS_TOKEN_REFRESH_URL = '/sns/oauth2/refresh_token?';
    /**
     * 平台网页授权后获取的access_token失效刷新地址
     */
    const WECHAT_OAUTH2_COMPONENT_ACCESS_TOKEN_REFRESH_URL = '/sns/oauth2/component/refresh_token?';
    /**
	 ...
	 * 快速注册小程序
	 */
    const WECHAT_FAST_REGISTER = '/cgi-bin/account/fastregister?';
	/**
	 * 获取素材列表
	 */
	const WECHAT_MATERIAL_BATCH_GET_URL = '/cgi-bin/material/batchget_material?';
	/**
	 * 修改永久图文素材
	 */
	const WECHAT_MATERIAL_UPDATE_NEWS_URL = '/cgi-bin/material/update_news?';
	/**
	 * 删除永久素材
	 */
	const WECHAT_DEL_MATERIAL_URL = '/cgi-bin/material/del_material?';


	/**
	 * 获取成功发布列表
	 */
	const WECHAT_BATCHGET_URL = '/cgi-bin/freepublish/batchget?';

	/**
	 * @var string 服务方的appid
	 */
    public $componentAppId;
	/**
	 * @var string 服务开发方的access_token
	 */
	public $_componentAccessToken;
    /**
     * @var string 公众号appId
     */
    public $appId;
	...
	public $errorCode = [
			...
			'45015'   => '截至当前，该粉丝尚未在48小时内与公众号互动或者该粉丝已取消关注，目前暂无法对其发送消息',
			'45016'   => '系统分组，不允许修改',
			'45017'   => '分组名字过长',
			'45018'   => '分组数量超过上限',
			'45047'   => '客服接口下行条数超过上限',
			'45056'   => '创建的标签数过多，请注意不能超过 100 个',
			'45057'   => '该标签下粉丝数超过 10 w，不允许直接删除',
			'45058'   => '不能修改 0/1/2 这三个系统默认保留的标签',
			'45064'   => '创建菜单包含未关联的小程序',
			'45065'   => '24 小时内已存在相同群发记录',
			'45066'   => '相同 clientmsgid 重试速度过快，请间隔 1 分钟重试',
			...
			'61454'   => '客服帐号名长度超过限制 ( 仅允许 10 个英文字符，不包括 @ 及 @ 后的公众号的微信号 )(invalid kf_account length)',
    ...
    public function getAccessToken($force = false)
    {
        if ($this->_accessToken === null || $this->_accessToken['expire'] < YII_BEGIN_TIME || $force) {
            $result = !$force && $this->_accessToken === null ? $this->getCache('access_token_' . $this->appId, false) : false;
            if ($result === false) {
                ...
                $this->setCache('access_token_' . $this->appId, $result, $result['expires_in']);
            } else {
	            if ($result['expire'] < YII_BEGIN_TIME) {
		            if (!($result = $this->requestAccessToken())) {
			            throw new HttpException(500, 'Fail to get access_token from wechat server.');
		            }
		            $this->trigger(self::EVENT_AFTER_ACCESS_TOKEN_UPDATE, new Event(['data' => $result]));
	...
	protected function requestAccessToken ($grantType = 'client_credential')
	{
		if (empty($this->componentAppId)) {
			...
			$wxAuthorize = WxAuthorize::getTokenInfo($this->appId);

			if (!empty($wxAuthorize)) {
				$result = [
					'access_token' => $wxAuthorize['access_token'],
					'expires_in'   => $wxAuthorize['expires'] - time(),
					'expire'       => $wxAuthorize['expires'],
				];
	 ...
	 * 设置jsapi_ticket
	 *
	 * @param array $data ['ticket' => 'ticket 字符串', 'expire' => 'ticket 超时时间']
	 */
	 ...
	 * @throws \yii\base\Exception
	 */
	public function getJsApiTicket ($force = false, $type = 'jsapi', $all = false)
	{
		if ($this->_jsApiTicket === NULL || $this->_jsApiTicket['expire'] < YII_BEGIN_TIME || $force) {
			$result = !$force && $this->_jsApiTicket === NULL ? $this->getCache('js_api_ticket_' . $this->appId . '_' . $type, false) : false;
			if ($result === false) {
				if (!($result = $this->requestJsApiTicket($type))) {
				...
				$this->setCache('js_api_ticket_' . $this->appId . '_' . $type, $result, $result['expires_in']);
			}
	...
	{
        return $this->httpRaw(self::WECHAT_MENU_CREATE_URL . 'access_token=' . $this->getAccessToken(), [
			'button' => $buttons
		]);
	}
     ...
     * @throws \yii\base\Exception
     */
    public function createPersonalizedMenu (array $buttons,array $matchrule)
    {
        return $this->httpRaw(self::PERSONALIZED_MENU_CREATE . 'access_token=' . $this->getAccessToken(), [
            'button' => $buttons,
            'matchrule'=>$matchrule
        ]);
    }
	...
	{
		$result = $this->httpRaw(self::WECHAT_CURRENT_MENU . 'access_token=' . $this->getAccessToken());
     ...
     * @throws \yii\base\Exception
     */
	public function deletePersonalizedMenu ($menuid)
	{
        return $this->httpRaw(self::PERSONALIZED_MENU_DELETE . 'access_token=' . $this->getAccessToken(), [
            'menuid' => $menuid
        ]);
	}
	 ...
	 * @param null  $url        模板消息跳转地址
	 * @param null  $miniprogram  小程序信息
	 * @param null  $type       1url2小程序
	 *
	 * @return bool|mixed
	 * @throws \yii\base\Exception
	 */
	public function sendTemplateMessage ($toUser, $templateId, array $data, $url = NULL, $miniprogram = NULL, $type)
	{
		if (empty($data)) {
			return false;
		}
		...
		if (!empty($result['errcode']) && isset($this->errorCode[$result['errcode']])) {
			$result['errmsg'] = $this->errorCode[$result['errcode']];
		}
		return $result;
	}
	 ...
	 *
	 * @param string $templateShortId
	 *
	 * @return array|bool
	 *
	 * @throws \yii\base\Exception
	 */
	public function addTemplate ($templateShortId)
	{
		if (empty($templateShortId)) {
			return false;
		}
		...
		$result = $this->httpRaw(self::WECHAT_TEMPLATE_API_ADD_TEMPLATE . 'access_token=' . $this->getAccessToken(), $requestParams);
    ...
    public function getTemplate(){
		...
		$result = $this->httpRaw(self::WECHAT_TEMPLATE_GET_URL . 'access_token=' . $this->getAccessToken());
	...
	public function getTemplateIndustry ()
	{
		...
		$result = $this->httpRaw(self::WECHAT_TEMPLATE_INDUSTRY_URL . 'access_token=' . $this->getAccessToken());
	...
	/**
	 * 发送图文客服消息(点击跳转到图文消息页面)
	 * @param $openId   关注者openID
	 * @param $mediaId  发送的已有图文的媒体ID
	 *
	 * @return bool
	 */
    public function sendNewsByMediaId($openId, $mediaId)
    {
        return $this->sendCustomMessage([
            'touser' => $openId,
            'msgtype' => 'mpnews',
	 ...
	 * @return bool
	 */
	public function sendMiniprogram ($openId, $miniprogrampage)
	{
		return $this->sendCustomMessage([
			'touser'          => $openId,
    ...
    /**
     * 群发消息
     * @param array $target 发送对象 tag_id 或 openid
     * ~~~
     * $target = [
     *     'filter' => [
     *          'tag_id' => 'tag_id',
	...
	public function sendArticles (array $target, $content, $type)
	{
		...
		if (array_key_exists("touser", $target)) {
			$url = self::WECHAT_MASS_SEND_URL;
		} else {
			$url = self::WECHAT_MASS_SEND_All_URL;
		}
		$result = $this->httpRaw($url . 'access_token=' . $this->getAccessToken(), $target + [
				$type     => $content,
				'msgtype' => $type
			]);
		if (!empty($result['errcode']) && isset($this->errorCode[$result['errcode']])) {
	...
	{
		$result = $this->httpRaw(self::WECHAT_MATERIAL_BATCH_GET_URL . 'access_token=' . $this->getAccessToken(), $params);
	...
	{
		$result = $this->httpRaw(self::WECHAT_DEL_MATERIAL_URL . 'access_token=' . $this->getAccessToken(), $params);
	 ...
	 * @throws \yii\web\HttpException
	 */
	public function uptMaterial ($params)
	{
		$result = $this->httpRaw(self::WECHAT_MATERIAL_UPDATE_NEWS_URL . 'access_token=' . $this->getAccessToken(), $params);
	 ...
	 * @return array|bool
	 */
	public function addMaterial ($filePath, $mediaType, $plus = [])
	{
		$mimeType = '';
		$fileName = '';
		if (!empty($plus['info'])) {
			$mimeType = !empty($plus['info']['mimetype']) ? $plus['info']['mimetype'] : '';
			$fileName = !empty($plus['info']['file_name']) ? $plus['info']['file_name'] : '';
		}
		if (!empty($mimeType) && !empty($fileName)) {
			// php 5.5将抛弃@写法,引用CURLFile类来实现 @see http://segmentfault.com/a/1190000000725185
			$media = class_exists('\CURLFile') ? new \CURLFile($filePath, $mimeType, $fileName) : '@' . $filePath;
		} else {
			// php 5.5将抛弃@写法,引用CURLFile类来实现 @see http://segmentfault.com/a/1190000000725185
			$media = class_exists('\CURLFile') ? new \CURLFile($filePath) : '@' . $filePath;
		}
		...
		if ($mediaType == 'video' && !empty($plus['description'])) {
			$postData['description'] = json_encode($plus['description'], JSON_UNESCAPED_UNICODE);
		}

		$result = $this->httpPost(self::WECHAT_MATERIAL_ADD_URL .
			'access_token=' . $this->getAccessToken() . '&type=' . $mediaType, $postData);
	 ...
	 * @return array|bool
	 */
	public function uploadImg ($filePath, $plus = [])
	{
		$mimeType = '';
		$fileName = '';
		if (!empty($plus['info'])) {
		...
		$result = $this->httpPost(self::WECHAT_MEDIA_UPLOAD_IMG . 'access_token=' . $this->getAccessToken(), $postData);
	 ...
	 *
	 * @param $mediaId 媒体文件id
	 * @param $type 0 图文、视频  >0 图片、音频
	 *
	 * @return array|bool
	 */
	public function getMaterial ($mediaId,$type=0)
	{
		if(!empty($type)){
			return self::WECHAT_BASE_URL . self::WECHAT_MATERIAL_GET_URL . 'access_token=' . $this->getAccessToken();
		}else{
			$result = $this->httpRaw(self::WECHAT_MATERIAL_GET_URL . 'access_token=' . $this->getAccessToken(), [
				'media_id' => $mediaId
			]);
	 ...
	 * @throws \yii\web\HttpException
	 */
	public function getBatchgetList ($params)
	{
		$result = $this->httpRaw(self::WECHAT_BATCHGET_URL . 'access_token=' . $this->getAccessToken(), $params);
	 ...
	 *
	 * @param        $wxName    微信号
	 * @param        $type      文本（text）  图文（mpnews） 图片（image） 语音（voice） 视频（mpvideo）
	 * @param string $mediaId   当type=text时 为文本，其它为mediaId
	 *
	 * @return array|bool
	 */
	public function sendPreviewMessage ($wxName, $type, $mediaId = '')
	{
		$content = [
			$type === 'text' ? 'content' : 'media_id' => $mediaId
		];
		$data    = [
			'towxname' => $wxName,
			'msgtype'  => $type,
		...
		$result  = $this->httpRaw(self::WECHAT_PREVIEW_MESSAGE_SEND_URL . 'access_token=' . $this->getAccessToken(), $data);
		if (isset($this->errorCode[$result['errcode']])) {
			$result['errmsg'] = $this->errorCode[$result['errcode']];
		}
		return $result;
	}
	...
	{
		$result = $this->httpRaw(self::WECHAT_CREATE_TAG_URL . 'access_token=' . $this->getAccessToken(), [
			'tag' => [
				'name' => $name
			]
		]);
		return isset($result['tag']) ? $result['tag'] : $this->errorCode[$result['errcode']];
	}
	...
	{
		$result = $this->httpRaw(self::WECHAT_GET_TAG_URL . 'access_token=' . $this->getAccessToken());
	...
	{
		$result = $this->httpRaw(self::WECHAT_UPDATE_TAG_NAME_URL . 'access_token=' . $this->getAccessToken(), [
			'tag' => [
				'id'   => $id,
				'name' => $name
			]
		]);
		return isset($result['errmsg']) && $result['errmsg'] == 'ok' ? 'ok' : $this->errorCode[$result['errcode']];
	}
	...
	public function deleteTag ($id)
	{
		...
		$result = $this->httpRaw(self::WECHAT_DELETE_TAG_URL . 'access_token=' . $this->getAccessToken(), [
			'tag' => [
				'id' => $id
			]
		]);
	 ...
	 * @throws \yii\base\Exception
	 */
	public function getUserByTag ($tagId, $nextOpenId = NULL)
	{

		$data = ['tagid' => $tagId];
		$nextOpenId === NULL && $data['next_openid'] = $nextOpenId;
		$result = $this->httpRaw(self::WECHAT_USER_GET_BY_TAG_URL . 'access_token=' . $this->getAccessToken(), $data);
		return !isset($result['errcode']) ? $result : false;
	}
	 ...
	 *
	 * @param $tagId        标签ID
	 * @param $openidList   用户 openid 列表
	 *
	 * @return bool
	 * @throws \yii\base\Exception
	 */
	public function memberBatchTag ($tagId, $openidList)
	{
		$result = $this->httpRaw(self::WECHAT_USER_BATCH_TAG_URL . 'access_token=' . $this->getAccessToken(), [
			'tagid'       => $tagId,
	 ...
	 * @throws \yii\base\Exception
	 */
	public function memberUnBatchTag ($tagId, $openidList)
	{
		$result = $this->httpRaw(self::WECHAT_USER_UNBATCH_TAG_URL . 'access_token=' . $this->getAccessToken(), [
			'tagid'       => $tagId,
			'openid_list' => $openidList
		]);
		return $result;
	...
	{
		$result = $this->httpRaw(self::WECHAT_GET_USER_TAGS_URL . 'access_token=' . $this->getAccessToken(), [
			'openid' => $openid
		]);
	 ...
	 *
	 * @param array $userList 需要获取的用户列表（最多100个）
	 *
	 * @return array|bool
	 */
	public function getMemberInfoBatchGet ($userList)
	{
		$result = $this->httpRaw(self::WECHAT_MEMBER_INFO_BATCHGET_URL . 'access_token=' . $this->getAccessToken(), [
			'user_list' => $userList
		]);
    ...
    public function getOauth2AuthorizeUrl($redirectUrl, $state = 'authorize', $scope = 'snsapi_base')
    {
    	...
    	if (!empty($this->componentAppId)) {
    		$oauthData['component_appid'] = $this->componentAppId;
	    }

        return self::WECHAT_OAUTH2_AUTHORIZE_URL . http_build_query($oauthData) . '#wechat_redirect';
    }
    ...
    public function getOauth2AccessToken($code, $grantType = 'authorization_code')
    {
    	if (empty($this->componentAppId)) {
		    ...
		    $result = $this->httpGet(self::WECHAT_OAUTH2_COMPONENT_ACCESS_TOKEN_URL . http_build_query([
				    'appid' => $this->appId,
				    'code' => $code,
				    'grant_type' => $grantType,
				    'component_appid' => $this->componentAppId,
				    'component_access_token' => $this->_componentAccessToken
			    ]));
	    }
    ...
    public function refreshOauth2AccessToken($refreshToken, $grantType = 'refresh_token')
    {
    	if (empty($this->componentAppId)) {
		    ...
		    $result = $this->httpGet(self::WECHAT_OAUTH2_COMPONENT_ACCESS_TOKEN_REFRESH_URL . http_build_query([
				    'appid'         => $this->appId,
				    'grant_type'    => $grantType,
				    'refresh_token' => $refreshToken,
				    'component_appid' => $this->componentAppId,
	 ...
	 * @param string $lang
	 * @param string $oauth2RefreshToken
	 *
	 * @return array|bool
	 */
	public function getSnsMemberInfo ($openId, $oauth2AccessToken, $lang = 'zh_CN', $oauth2RefreshToken = '')
	{
		$result = $this->httpGet(self::WEHCAT_SNS_USER_INFO_URL . http_build_query([
				'access_token' => $oauth2AccessToken,
				'openid'       => $openId,
				'lang'         => $lang
			]), null, $oauth2RefreshToken);
	...
	{
		$raw = Json::encode(['ticket' => $ticket]);

		$result = $this->httpRaw(static::WECHAT_FAST_REGISTER . 'access_token=' . $this->getAccessToken(), $raw);
	 ...
	 * @return bool|mixed
	 */
	public function httpGet ($url, $params = null, $refreshToken = '')
	{
		return $this->parseHttpResult($url, $params, 'get', true, $refreshToken);
	}
	 ...
	 * @param        $params
	 * @param        $method
	 * @param bool   $force        是否强制更新 access_token 并再次请求
	 * @param string $refreshToken 是否存在 refreshToken 并通过 refreshToken 重新获取新的 accessToken
	 *
	 * @return bool|mixed
	 */
	protected function parseHttpResult ($url, $params, $method, $force = true, $refreshToken = '')
	{
		...
		if (isset($return['errcode']) && $return['errcode']) {
			...
			switch ($return['errcode']) {
				...
				case 41001: //access_token 失效,强制更新access_token, 并更新地址重新执行请求
				case 42001: //access_token 失效,强制更新access_token, 并更新地址重新执行请求
					if ($force) {
						...
						if (empty($refreshToken)) {
							...
							$newAccessTokenData = $this->refreshOauth2AccessToken($refreshToken);
							if (!empty($newAccessTokenData)) {
								$newAccessToken = $newAccessTokenData['access_token'];
								$url            = preg_replace("/access_token=([^&]*)/i", 'access_token=' . $newAccessToken, $url);
								$return         = $this->parseHttpResult($url, $params, $method, false); // 仅重新获取一次,否则容易死循环
							}
						}
					}
